    ...
    <section class="py-12 px-6 md:px-0 max-w-screen-xl mx-auto">
      <div class="pt-10 p-2 min-h-screen flex flex-col">
          <div class="flex flex-row justify-center items-center space-x-8 mb-8">
              <button 
                @click="currentView = 'global'"
                :class="[currentView === 'global' ? 'text-indigo-700 border-b-2 border-indigo-700' : 'text-indigo-900',
              ...
              <button 
                ...
                :class="[currentView === 'event' ? 'text-indigo-700 border-b-2 border-indigo-700' : 'text-indigo-900',
                  'text-2xl font-bold pb-2']"
              >
                Event Report
              </button>
          ...
          <div v-else class="w-full">
            ...
            <div v-else>
              <button 
                ...
                class="mb-6 flex items-center text-indigo-700 hover:text-indigo-900"
              >

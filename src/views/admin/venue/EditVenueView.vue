<template>
    ...
    <div class="max-w-lg mx-auto p-6 mt-20 bg-white rounded-xl shadow-md space-y-6">
        <h1 class="font-semibold text-2xl text-center">Update Venue</h1>
    ...
    methods: {
        ...
        async getItem() {
            try {
                ...
                console.log('Response:', res.data.data); // Tambahkan log ini untuk melihat respons

                const venue = res.data.data;

                this.form.name = venue.name;
                this.form.address = venue.address;
        ...
        async submitForm() {
            ...
            if (this.form.image_file) {
                ...
                // Jika tidak ada file yang diupload, hapus field image_file dari FormData
